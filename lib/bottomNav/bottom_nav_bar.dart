...
class _BottomNavBarState extends State<BottomNavBar>
  ...
  void initState() {
    ...
    //   ..initialize(context)
    //   ..getToken(context);
    // ForceUpdate.checkForAppUpdate(context);
  }
    ...
    return Stack(
      children: [
        ...
        Scaffold(
          ...
          // appBar: CustomAppBar.appbar(fromHome: true, ctx: context),/TODO need change
          // drawer: const CustomDrawer(),/TODO need change
        ...
        // const LuckDrawScreen(),
        // authLoader(context),/TODO need changes
      ],
    );
  }
}
