...
class SmsfCorporateTrusteeForm extends StatefulWidget {
  final ScrollController? scrollController;
  const SmsfCorporateTrusteeForm({super.key, this.scrollController});

  @override
  State<SmsfCorporateTrusteeForm> createState() =>
      _SmsfCorporateTrusteeFormState();
}

class _SmsfCorporateTrusteeFormState extends State<SmsfCorporateTrusteeForm> {
  // ============ ADD FORM KEYS ============
  ...
  bool _validateUpToStep(int targetStep) {
    ...
    // Validate step 1 (Trust) if trying to go to step 2 or beyond
    if (targetStep >= 2) {
