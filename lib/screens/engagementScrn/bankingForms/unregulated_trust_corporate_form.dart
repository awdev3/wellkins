...
class UnregulatedTrustCorporateForm extends StatefulWidget {
  final ScrollController? scrollController;
  const UnregulatedTrustCorporateForm({super.key, this.scrollController});

  @override
  State<UnregulatedTrustCorporateForm> createState() =>
      _UnregulatedTrustCorporateFormState();
}

class _UnregulatedTrustCorporateFormState
    extends State<UnregulatedTrustCorporateForm> {
  // ============ ADD FORM KEYS ============
  ...
  void _addDirector() {
    setState(() {
      ...
      // Create corresponding signature
      signatures.add({
  ...
  void _removeDirector(int index) {
    setState(() {
      ...
      // Dispose corresponding signature controllers
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          if (currentStep == 3)
            Form(key: _bankFormKey, child: bankDetailCard()),
          if (currentStep == 4)
            Form(
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                // Only show delete button from 2nd director (index >= 1)
                SizedBox(
                  width: 40.w,
                  child: index >= 1
                      ? IconButton(
        ...
        FormHelpers.buildCardWithHeader(
          ...
          Column(
            ...
            children: [
              ...
              // FIXED: Use FormHelpers.pickFiles() with async/await
  ...
  Widget _buildNavigationButtons() {
    ...
    bool isDeclarationStep = currentStep == 5;
