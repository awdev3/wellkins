...
class SmsfIndividualTrusteeForm extends StatefulWidget {
  final ScrollController? scrollController;
  const SmsfIndividualTrusteeForm({super.key, this.scrollController});

  @override
  State<SmsfIndividualTrusteeForm> createState() =>
      _SmsfIndividualTrusteeFormState();
}

class _SmsfIndividualTrusteeFormState extends State<SmsfIndividualTrusteeForm> {
  // ============ ADD FORM KEYS ============
          ...
          Column(
            ...
            children: [
              ...
              FormHelpers.buildTextField(
                ...
                regErrorText: AppConstants.nameRegError, // ADD
                regExp: Regx.fullNameRegExp, // ADD
              ),
              Spacers.sb15(),
              FormHelpers.buildTextField(
            ...
            child: Column(
              ...
              children: [
                ...
                FormHelpers.buildTextField(
                  ...
                  regErrorText: AppConstants.emailRegError, // ADD
                ...
                FormHelpers.buildTextFieldRow([
                  {
                    ...
                    "hint": "ex.987678567",
                    "digit": true,
                    "regErrorText": AppConstants.phoneRegError, // ADD
                    "regExp": Regx.nineDigitRegExp, // CHANGE
                  },
                  {
                    "label": "House/Unit No",
            ...
            children: [
              ...
              RadioGroup<String>(
                ...
                child: RadioListTile<String>(
                  ...
                  title: TextWidget(
                    text:
                        "An original certified copy or extract of the trust deed",
                    fontSize: 14,
                  ...
                  child: _buildButton(
                    ...
                    onPressed: () {
                      setState(() {
                        ...
                        trustNameCntlr.clear();
                        businessNameCntlr.clear();
                        abnTfnCntlr.clear();
                        trustTypeCntlr.clear();
                        countryCntlr.clear();
                        ...
                        // Clear bank details if on bank step
                        if (currentStep == 1) {
                          financialInstitutionCntlr.clear();
                          accountNameCntlr.clear();
                          bsbCntlr.clear();
                          accountNumberCntlr.clear();
                          incomeDistributionOption = null;
                        }

                        // Clear all trustees
                        for (var trustee in trustees) {
                          (trustee['firstName'] as TextEditingController)
                              .clear();
                          (trustee['middleName'] as TextEditingController)
                              .clear();
                          (trustee['surname'] as TextEditingController).clear();
                          (trustee['dob'] as TextEditingController).clear();
                          (trustee['email'] as TextEditingController).clear();
                          (trustee['phone'] as TextEditingController).clear();
                          (trustee['houseUnit'] as TextEditingController)
                              .clear();
                          (trustee['streetName'] as TextEditingController)
                              .clear();
                          (trustee['suburb'] as TextEditingController).clear();
                          (trustee['postcode'] as TextEditingController)
                              .clear();
                          trustee['title'] = null;
                          trustee['streetType'] = null;
                          trustee['state'] = null;
                          trustee['correspondence'] = 'YES';
                          trustee['politicallyExposed'] = null;
                        }
                      });
