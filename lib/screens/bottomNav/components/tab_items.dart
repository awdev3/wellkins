...
import '../../historyScrn/history_screen.dart';
import '../../homeScrn/home_screen.dart';
import '../../settingsScrn/settings_screen.dart';
...
class NavComponents {
  ...
  static List<Widget> screens = [
    const HomeScreen(),
    const HistoryScreen(),
    // Center(child: const Text("No Screen Available")),
